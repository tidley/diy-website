...
var fileFuns = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_1.promises.writeFile(fileName, contents, _encoding)];
                case 1:
                    _a.sent(),
                        function (err) {
    ...
    appendToFile: function (fileName, data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.promises.appendFile(fileName, data)];
                case 1:
                    _a.sent(),
                        function (err) {
                            response = errHandle(err);
    ...
    readFromFile: function (fileName, encoding) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fs_1.promises.readFile(fileName, _encoding)];
                case 2:
                    data = _a.sent();
